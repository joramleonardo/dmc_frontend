              ...
              <div class="container-xl">
                  <div class="row row-cards">
                    <div class="col-lg-8">
                      <div class="row row-cards">
                        <div class="col-12">
                            <b-form class="card" id="createEventForm" >
                            ...
                            <div class="card-body">
                                <b-form class="createEventForm" id="createEventForm">
                                    ...
                                    <div class="mb-3">
                                        <b-form-group class="group">
                                            <label class="form-label"><span style="color: red;">* </span>Short Description:</label> 
                                            <textarea class="form-control" v-model="ticketData.eventDescription" rows="3" placeholder="Short description here.."></textarea>
                                        </b-form-group> 
                                    </div>
                                    <div class="mb-3">
                                        <b-form-group class="group">
                                    ...
                                    <div class="mb-3">
                                        <b-form-group class="group">
                                            <label for="entryDate" class="label"><span style="color: red;">* </span>Category:</label>
                                            <div class="col">
                                                <select class="form-select" v-model="selected_category_album">
                                                    <option selected disabled>Please select category</option>
                                                    <option value="1">Assistant Secretaries</option>
                                    ...
                                    <div class="mb-3">
                                        <b-form-group class="group" id="form_externalEventDate">
                                            <label for="entryDate" class="label"><span style="color: red;">* </span>Sector:</label>
                                            <div class="col">
                                                <select class="form-select" v-model="selected_sector">
                                                    <option selected disabled>Please select sector</option>
                                                    <option value="1">Collegial and Scientific Bodies</option>
